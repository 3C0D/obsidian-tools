...
import {
	registerOutOfVault,
	createMoveFilesMenuCallback
} from '../move-ou-from-vault/move-out-menus.ts';
import {
	addDeleteEmptyFolders,
	createDeleteEmptyFoldersMenu
} from '../delete-empty-folders/delete-empty-folders.ts';
	...
	// Search from directory is now native in Obsidian
	{
		...
		callback: async function (
			...
			if (value) {
				...
				const list = [
					'obsidian-my-tools:move-files-to-vault',
					'obsidian-my-tools:move-directory-to-vault',
					'obsidian-my-tools:copy-files-to-vault',
					'obsidian-my-tools:copy-directory-to-vault'
				];
